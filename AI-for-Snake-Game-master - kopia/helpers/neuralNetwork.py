...
def mapChrom2Weights(chrom, bitsPerWeight, numInputs, numHiddenLayerNodes, numOutputs):
	...
	#While we are still looking at the bits representing weights going into hidden layer 1
	...
	#While we are still looking at the bits representing weights going into hidden layer 2
